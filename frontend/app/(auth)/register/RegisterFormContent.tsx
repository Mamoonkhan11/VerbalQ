...
export default function RegisterFormContent({ fromLimit: initialFromLimit }: RegisterFormContentProps) {
  ...
  // Use prop first, then fallback to searchParams
  const fromLimit = initialFromLimit || searchParams.get('from') === 'limit'
